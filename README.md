...
* Updated Azure data files can be found [here](https://www.microsoft.com/en-us/download/details.aspx?id=56519). 
	...
	* Copy the link in the Download button and execute: `curl -sSL -o ./cloud_ip_data/azure.json "https://download.microsoft.com/download/7/1/d/71d86715-5596-4529-9b13-da13a5de5b63/ServiceTags_Public_20251215.json"`
